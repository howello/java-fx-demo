...
import com.howe.constant.CssConstant;
...
public class AlertMaker {
    ...
    public static void showSuccessAlert(String content) {
        showSimpleAlert("成功", content);
    }

    public static void showErrorAlert(String content) {
        showSimpleAlert("失败", content);
    }
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(ResourceConstant.ICON));
            TrayIcon trayIcon = new TrayIcon(image, SettingUtils.SETTING_CACHE.getGlobal().getTitle());
    ...
    private static void styleAlert(Alert alert) {
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource(CssConstant.DARK_THEME).toExternalForm());
